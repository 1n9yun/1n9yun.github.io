...
SpringSecurity가 제공하는 Interface, 구현체 ... 는 <a href="javascript:alert('아직이욥! ㅎㅎ;ㅈㅅ...ㅋㅋ!!')">여기</a>에 정리합니다.
{:.note}

[SpringSecurity docs - Authentication ...](https://docs.spring.io/spring-security/site/docs/current/reference/html5/#servlet-authentication)
{:.note title="prerequisite"}
